    ...
    <>
      {
        adminOrderLoading ? (
          ...
          <div className="w-full p-3 h-[100vh] overflow-y-auto">
            <div className="text-[22px] font-bold mb-3 !text-center font-Poppins">Overview</div>
            <div className="w-full block 800px:flex items-center justify-between">
              ...
              <div className="w-full mb-4 800px:w-[30%] min-h-[20vh] bg-white shadow rounded px-2 py-5">
                <div className="flex items-center">
                  <FaShop size={30} className="mr-3" fill="#00000085" />
                  <h3
                    className={`${styles.productTitle} !text-[18px] leading-5 !font-[400] text-[#00000085]`}
                  >
                    All Sellers
            ...
            <br />
            <h3 className="text-[22px] text-center font-Poppins pb-2">Latest Orders</h3>
